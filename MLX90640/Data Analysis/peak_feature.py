...
path1 = r"C:\Users\animo\Downloads\MS\Pi_4B\MLX\data\dc_0\data_0\Pixels" 
...
def feature_extraction(data_frame, it_frame, filtered_frame):
    ...
    binary_frame, active_pixels = binarize(data_frame, it_frame+0.2)
...
for i in range(0, len(backg_matrices)):
    ...
    empty_list.append([fv1, fv2, fv3, fv4, fv5, fv6, 0, 0])
...
for i in range(0, len(data_frame)):
    ...
    empty_list.append([fv1, fv2, fv3, fv4, fv5, fv6, fv7, j])
    valid_blobs = []
...
data.to_csv(r"C:\Users\animo\Downloads\MS\Pi_4B\MLX\data\dc_0\peak_features.csv")